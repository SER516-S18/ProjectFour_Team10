...
public class ClientWindowView extends JFrame {
    ...
    /**
      * initTabs: Initialize different tabs
      */
	 ...
	 * @param facialExpressionPanel: Panel to plot facial expression
	 * @param perfomPanel: Panel to plot information
	 */
	 ...
	 * @param facialPanel: Panel to plot face
	 * @param plotPanel: Panel to plot information
	 */
	...
	/**
	 * update client view 
	 * @param param : parameters for facial expression
	 */
	 ...
	 * @param status : Status information for client
	 * @param time : Time of the status update
	 */
