 ...
 * @author Group10
 * @version 1.0
 * Parameters class : All parameters for face
 */
public class Parameters {
    ...
    /**
     * Empty constructor for Parameters class
     */
    public Parameters() { }

    /**
     * Constructor for Parameters class
     * @param eye : information about eyes
     * @param lowerFace : information about lower face
     * @param upperFace : information about upper face
     * @param performance : information about performance
     * @param time : time of information
     */
    public Parameters(Eye eye, LowerFace lowerFace, UpperFace upperFace, 
    				PerformanceMet performance, double time) {
        this.eye = eye;
